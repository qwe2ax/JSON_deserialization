...
public class AnalyticService {
    ...
    public static void printAnalytic() {
        ...
        long avgLifetimeForCompanies = getAvgLifeTime(companies);
        long avgLifetimeForEntrepreneurs = getAvgLifeTime(entrepreneurs);
...
//        System.out.println(companies.size());
    ...
    public static <T extends Company> long getAvgLifeTime(List<T> companies) {
        Map<String, LocalDateTime> companyCreationDates = companies.stream()
                ...
                .collect(Collectors.toMap(Company::getId, company -> LocalDateTime.parse(company.getCreationDate())));
